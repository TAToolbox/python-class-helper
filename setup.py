...
setup(
    ...
    install_requires=['altgraph==0.16.1', 'astroid==2.2.5', 'autopep8==1.4.4', 'Click==7.0', 'colorama==0.4.1', 'future==0.17.1', 'gitdb2==2.0.5', 'GitPython==3.1.37', 'importlib-metadata==0.22', 'isort==4.3.21', 'lazy-object-proxy==1.4.2', 'mccabe==0.6.1', 'more-itertools==7.2.0',
